...
import joinanimition from "./animation/join.json";
          ...
          <div className="self-center">
            <form className="flex flex-col gap-3">
              ...
              <div className="flex w-[100%] flex-col gap-1">
                <select
                  type="text"
                  className=" order-2 border border-[rgba(0,0,0,.1)] rounded px-4 py-3 w-full"
                >
                  {" "}
                  <option> Course one </option>{" "}
                </select>
                <label className="text-primary order-1">Courses *</label>
              </div>
              <div className="flex w-[100%] flex-col gap-1">
                <textarea
                  id="message"
